...
AFS_PATH=${AFS_PATH-/afs/cs.cmu.edu/academic/class/15410-f15/Web/update/proj4}
WEB_URL=${WEB_URL-'http://www.cs.cmu.edu/~410-f15/update/proj4'}

#AFS_PATH='/afs/cs.cmu.edu/academic/class/15410-f15/private/davide/update/proj4'
#WEB_URL='http://www.cs.cmu.edu/~410-s16/update/proj4'
#echo 'OVERRIDE'; sleep 2
#echo 'OVERRIDE'; sleep 2
