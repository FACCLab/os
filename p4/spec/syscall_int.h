...
#define UDRIV_REGISTER_INT   0x65
#define UDRIV_DEREGISTER_INT 0x66
#define UDRIV_SEND_INT       0x67
#define UDRIV_WAIT_INT       0x68
#define UDRIV_INB_INT        0x69
#define UDRIV_OUTB_INT       0x6A
#define UDRIV_MMAP_INT       0x6B
